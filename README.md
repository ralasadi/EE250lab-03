...
One common REST method not used in our mail server is cacheability which is the process of storing some responses on the client or an intermeidsary to improve server response time. We could extend out mail server to use this method by having the client cache a resource such as...
